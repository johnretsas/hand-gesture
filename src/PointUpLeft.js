...
const pointLeftDescription = new GestureDescription('Up Left');
...
pointLeftDescription.addDirection(Finger.Ring, FingerDirection.HorizontalRight, 1.0);
pointLeftDescription.addDirection(Finger.Ring, FingerDirection.DiagonalUpRight, 1.0);

// pinky:
pointLeftDescription.addCurl(Finger.Pinky, FingerCurl.FullCurl, 1.0);
pointLeftDescription.addDirection(Finger.Pinky, FingerDirection.HorizontalRight, 1.0);
