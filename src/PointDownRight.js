...
const pointRightDescription = new GestureDescription('Down Right');
...
pointRightDescription.addDirection(Finger.Index, FingerDirection.DiagonalDownLeft, 1.0);
...
pointRightDescription.addDirection(Finger.Middle, FingerDirection.DiagonalDownLeft, 1.0);
...
pointRightDescription.addDirection(Finger.Ring, FingerDirection.DiagonalDownLeft, 1.0);

// pinky:
pointRightDescription.addCurl(Finger.Pinky, FingerCurl.FullCurl, 1.0);
pointRightDescription.addCurl(Finger.Ring, FingerCurl.FullCurl, 1.0);
pointRightDescription.addDirection(Finger.Ring, FingerDirection.HorizontalLeft, 1.0);
pointRightDescription.addDirection(Finger.Pinky, FingerDirection.DiagonalDownLeft, 1.0);
